...
urlpatterns = [
    ...
    url(r'^posts/(?P<post_url>\w+)/send_comment', views.send_comment, name='send_comment'),
    url(r'^send_answer_to_comment/(?P<post_url>\w+)/(?P<comment_id>[0-9]+)/', views.send_answer_to_comment, name='send_answer_to_comment'),
    url(r'^posts/(?P<post_url>\w+)/$', views.detail, name='detail'),
